...
/**
 * Sets up the note settings modal and its rendered button
 */
function renderNoteSettingsButton() {
  const modalContent = document.createElement("div");
  modalContent.appendChild(document.createTextNode("Note meta data."));

  // TODO: figure out the best way to get the notes state

  // Add a button to delete the note
  // Add note data
  // add note input (make it a component)
